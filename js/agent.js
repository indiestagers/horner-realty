/* ============================================================
   HORNER REALTY KC — "Ramon" voice agent widget (Vapi)
   Renders the bottom-right avatar + panel and drives a Vapi
   web call. Config lives in js/agent-config.js. The Vapi SDK
   is only downloaded when a call starts.
   ============================================================ */
...
(function () {
  ...
  root.innerHTML = `
    <div class="hra-panel" role="dialog" aria-label="${cfg.agentName} — voice assistant">
      ...
      <div class="hra-body">
        <p class="hra-copy hra-copy-idle">Hey, I'm <strong>${cfg.agentName}</strong> — <em>ask me anything</em>: listings, neighborhoods, what your home might be worth. I can even book you a time with Alicia, Brian &amp; Tyler.</p>
      ...
      <div class="hra-foot">
        ...
        <span><b>Horner Realty</b> KC</span>
      </div>
    </div>
  ...
  async function startCall() {
    ...
    if (!configured) {
      showNote(`${cfg.agentName} is warming up his voice — the line isn't connected just yet. Call us directly at (913) 238-6184, or try again soon!`);
      console.warn(
