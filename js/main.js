/* ============================================================
   HORNER REALTY KC — Site behavior
   ============================================================ */
    ...
    if (featured.length) {
      ...
      featuredWrap.innerHTML = `
        <div class="empty-state" style="grid-column:1/-1">
          ...
          <p>Our next homes are being prepared for market right now. Call us at (913) 238-6184 to hear about them first.</p>
        </div>`;
    }
  }
